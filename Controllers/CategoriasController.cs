...
namespace PaladarAPI.Controllers
{
    ...
    {
        private PaladarMobileEntities9 db = new PaladarMobileEntities9();
        ...
        public IHttpActionResult PostCategorias(Categorias categorias)
        {
            ...
            return CreatedAtRoute("DefaultApi", new { id = categorias.Row }, categorias);
        }
        ...
        {
            return db.Categorias.Count(e => e.Row == id) > 0;
        }
    }
}